              ...
              <div class="container">
                ...
                <form class="form-login" method="post" action="proseslogin.php">
                  ...
                  <div class="login-wrap">
                    <input name="username" id="username" type="input" class="form-control" autocomplete="off"
                    ...
                    <div class="login-social-link centered">
                      ...
                      <a href="login-guru.php" class="btn btn-warning" type="submit"><i class="fa fa-user"></i>
                        Guru</a>
                    </div>
