          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <table class="table table-responsive table-bordered table-hover table-striped tablesorter">
                      ...
                      <?php 
                      include "../conn.php";
                        $query = mysqli_query($koneksi, "SELECT * FROM nilai, pelajaran, siswa WHERE nilai.kode_pelajaran = pelajaran.kode_pelajaran AND nilai.kode_siswa = siswa.kode_siswa");
