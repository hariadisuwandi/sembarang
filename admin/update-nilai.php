...
$query = mysqli_query($koneksi, "UPDATE nilai SET semester='$semester', kode_pelajaran='$kode_pelajaran', kode_guru='$kode_guru', kode_kelas='$kode_kelas', kode_siswa='$kode_siswa', nilai_tugas1='$nilai_tugas1', nilai_tugas2='$nilai_tugas2', nilai_tugas3='$nilai_tugas3', nilai_uts='$nilai_uts', nilai_uas='$nilai_uas', keterangan='$keterangan' WHERE id='$id'");
if ($query){
