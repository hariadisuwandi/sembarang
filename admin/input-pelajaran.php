...
$query_pelajaran = mysqli_query($koneksi, "SELECT * FROM pelajaran order by kode_pelajaran desc");
$row_pelajaran = mysqli_fetch_array($query_pelajaran);
$totalrow_pelajaran = mysqli_num_rows($query_pelajaran);
