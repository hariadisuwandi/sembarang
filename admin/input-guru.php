...
$query_guru = mysqli_query($koneksi, "SELECT * FROM guru order by kode_guru desc");
$row_guru = mysqli_fetch_array($query_guru);
$totalrow_guru = mysqli_num_rows($query_guru);
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <select name="pelajaran" id="pelajaran"  class="form-control" required />
                                    <option> ---- Pilih Salah Satu ---- </option>
                                    <?php
                                    $sql = mysqli_query($koneksi, "SELECT * FROM pelajaran order by nama_pelajaran asc ");
